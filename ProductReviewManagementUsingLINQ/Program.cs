    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            List<ProductReviewModel> list = new List<ProductReviewModel>()
            {
                ...
                new ProductReviewModel() {ProductId=4, UserId=10, Rating=5, Review="Average", IsLike=true},
                ...
                new ProductReviewModel() {ProductId=5, UserId=10, Rating=6, Review="Good", IsLike=true},
                ...
                new ProductReviewModel() {ProductId=15, UserId=10, Rating=7, Review="Good", IsLike=true},
                ...
                new ProductReviewModel() {ProductId=21, UserId=10, Rating=1, Review="Bad", IsLike=true},
            ...
            while (flag)
            {
                ...
                switch (option)
                {
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        management.RetrieveRecordsSpecificUserIdBasedOnRating(list);
                        break;
                    case 14:
                        flag = false;
                        break;
